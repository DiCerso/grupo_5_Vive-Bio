...
| `Cuarto Sprint` | -Daylis. Compañero. Consultar dudas. |  -Weeklis. Realizar más prácticas individuales y grupales. | -No delegar tareas equitativamente. | -Posponer daylis. | -Adaptarse. -Centrarse más en visualización de código. -Preguntar antes de hacer un cambio significativo. -Comunicar | 
